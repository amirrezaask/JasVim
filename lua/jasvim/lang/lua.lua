...
function M.configs()
  jasvim.with("neodev", function(neodev)
    neodev.setup {}
  end)
  ...
  if jasvim.lang.has_treesitter "lua" then
    jasvim.treesitter.ensure "lua"
  end

  if jasvim.lang.has_autoformat "lua" then
  ...
  if jasvim.lang.has_lsp "lua" then
    jasvim.lsp.config("sumneko_lua", {
